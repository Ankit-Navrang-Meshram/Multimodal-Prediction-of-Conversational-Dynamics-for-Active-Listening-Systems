...
from fusion import QuaternionFusion
from fusion2 import DeepLowRankFusion
...
class LanguageAudioVisionModel(nn.Module):
    def __init__(self, text_ckpt_path=None, audio_ckpt_path=None, vision_ckpt_path=None, fusion_module=None):
        ...
        # print("Fusion module : QuaternionFusion")
        # self.fusion = QuaternionFusion(feature_dim=256, output_dim=3)
        print("Fusion module : DeepLowRankFusion")
        self.fusion = DeepLowRankFusion(rank=16)
        # else:
        #     self.fusion = LMF()
